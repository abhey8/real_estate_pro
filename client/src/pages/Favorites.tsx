...
export default function Favorites() {
  ...
  const loadFavorites = async () => {
    try {
      ...
      setFavorites(response.data.favorites.map((f: any) => f.listing));
    } catch (error) {
    ...
    <div className="min-h-screen pt-20 pb-16 px-4 bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8 pb-6 border-b border-gray-200">
          <div>
            <h1 className="text-4xl text-black tracking-tight mb-2">My Favorites</h1>
            <p className="text-gray-500 text-lg">Properties you've saved</p>
          </div>
        </div>
        ...
        {favorites.length === 0 ? (
          ...
          >
            ...
            <h3 className="text-2xl mb-2 font-medium">No favorites yet</h3>
              ...
              >
                ...
                <div className="p-6 flex-1 flex flex-col">
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <button
                      onClick={(e) => handleRemoveFavorite(e, listing._id)}
                      className="p-2 bg-red-50 text-red-500 rounded-full hover:bg-red-100 hover:text-red-600 transition-colors tooltip flex-shrink-0"
